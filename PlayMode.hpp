...
struct PlayMode : Mode {
	...
	bool isEnd = false;
	bool isScored = false;
	float counterForScore = 2.0f;
	size_t currentScoreIndex = 0;
	...
	//music 
	std::array<std::shared_ptr< Sound::Sample >, 13> pitches;
	std::vector<std::shared_ptr< Sound::PlayingSample >> currentPlayingPitches;
